...
mv "$PBS_JOBFS/hic.R1.subset.fastq.gz" ${outdir}/${sample}.${scaffold}.hic.R1.subset.fastq.gz
mv "$PBS_JOBFS/hic.R2.subset.fastq.gz" ${outdir}/${sample}.${scaffold}.hic.R2.subset.fastq.gz
